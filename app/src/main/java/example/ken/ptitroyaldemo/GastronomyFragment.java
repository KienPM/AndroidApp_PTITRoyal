...
public class GastronomyFragment extends Fragment {
    ...
    private RecyclerView rvGastronomyPosts;
    private PostsAdapter adapter;
    private View rootView;
    private SwipyRefreshLayout swipyRefreshrvGastronomy;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        rvGastronomyPosts = (RecyclerView) rootView.findViewById(R.id.rvGastronomyPosts);
        adapter = new PostsAdapter(getActivity(), posts);
        RecyclerView.LayoutManager layoutManager =
                new LinearLayoutManager(getActivity(), LinearLayoutManager.VERTICAL, false);
        rvGastronomyPosts.setLayoutManager(layoutManager);
        rvGastronomyPosts.setItemAnimator(new DefaultItemAnimator());
        rvGastronomyPosts.setAdapter(adapter);

        swipyRefreshrvGastronomy = (SwipyRefreshLayout) rootView.findViewById(R.id.swipyRefreshGastronomy);
        swipyRefreshrvGastronomy.setOnRefreshListener(new SwipyRefreshLayout.OnRefreshListener() {
            @Override
            public void onRefresh(SwipyRefreshLayoutDirection direction) {
                ...
                swipyRefreshrvGastronomy.setRefreshing(false);
            }
        });
